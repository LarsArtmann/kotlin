...
class FirConeTypeRendererOptions {
    var shortQualifiedNames = false
...
class FirRendererOptions {
    ...
    var typeRendererOptions: FirConeTypeRendererOptions? = null
    ...
    var approximateTypes: Boolean = false
